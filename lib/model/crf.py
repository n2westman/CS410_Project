...
#https://github.com/kmkurn/pytorch-crf/blob/master/src/torchcrf/__init__.py
class CRF(nn.Module):
    ...
    def decode(self, emissions, mask = None):
        ...
        for emission, mask_ in zip(emissions, mask):
            ...
            scores, tags = self._viterbi_decode(emission[:seq_length])
            best_tags.append(tags)
            best_scores.append(scores)
        best_scores = torch.stack(best_scores)
        return best_scores, best_tags
    ...
    def _viterbi_decode(self, emission):
        ...
        best_last_score, best_last_tag = viterbi_score.max(0)
        ...
        best_tags.reverse()
        return viterbi_score, best_tags
